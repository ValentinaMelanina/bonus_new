/**
 * Created by valentinamelanina on 06.07.17.
 */
...
gulp.task('scripts', function() {
    return gulp.src([ // Берем все необходимые библиотеки
        'app/js/vendors/*.js', // Берем js из vendors_js
...
gulp.task('build', ['clean', 'img', 'scripts'], function() {
    ...
    // Переносим HTML
    var buildHtml = gulp.src('app/html/pages/*.html')
        .pipe(gulp.dest('dist'));
